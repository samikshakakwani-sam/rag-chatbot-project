...
### 1. Corpus Definition
The assistant is currently limited to a corpus consisting of the following 5 target HDFC Mutual Fund URLs on Groww:
...
- Benchmark index
- Fund management data (e.g., fund manager name)
